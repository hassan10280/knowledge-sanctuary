      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <Input
              placeholder="Search by Order ID, Transaction ID, or Name..."
              value={search}
              ...
              <div className="space-y-5">
                ...
                <div className="bg-muted/50 rounded-lg p-4 space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Placed: {new Date(selectedOrder.created_at).toLocaleString("en-GB")}
                  </p>
                </div>
                ...
                <div className="bg-muted/50 rounded-lg p-4 space-y-2">
                  ...
                  {Number(selectedOrder.coupon_discount) > 0 && (
                    <div className="flex justify-between text-sm text-emerald-600">
                      ...
                      <span>-£{Number(selectedOrder.coupon_discount).toFixed(2)}</span>
                    </div>
                  )}
                  <div className="flex justify-between text-sm">
                    <span>Shipping</span>
