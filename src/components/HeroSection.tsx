    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-primary">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <motion.p
          ...
          className="tracking-meta text-gold mb-6"
        >
        ...
        >
          ...
          <em className="text-gold">of Knowledge</em>
        </motion.h1>
        ...
        >
          <div className="relative group">
            <div className="absolute inset-0 bg-primary-foreground/10 rounded-lg backdrop-blur-xl border border-primary-foreground/20 group-focus-within:border-gold transition-colors duration-500" />
            <div className="relative flex items-center">
              ...
              />
              <button className="absolute right-3 px-6 py-2.5 bg-gold text-accent-foreground font-medium text-sm rounded-md hover:brightness-110 transition-all duration-300">
                Search
              </button>
            </div>
          </div>
        ...
        >
          {["Quran", "Hadith", "Fiqh", "History", "Kids"].map((cat) => (
            <span
              key={cat}
              className="px-4 py-1.5 text-xs tracking-meta border border-primary-foreground/20 text-primary-foreground/60 rounded-full hover:border-gold hover:text-gold cursor-pointer transition-all duration-300"
            >
              {cat}
            </span>
          ))}
