          ...
          <div className="px-6 sm:px-8 py-6 sm:py-8">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-[hsl(var(--sand))] border-[hsl(var(--border))] text-[hsl(var(--foreground))] placeholder:text-[hsl(var(--muted-foreground))]"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 bg-[hsl(var(--sand))] border-[hsl(var(--border))] text-[hsl(var(--foreground))] placeholder:text-[hsl(var(--muted-foreground))]"
                    required
                    minLength={6}
                  />
                  <button
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-[hsl(var(--sky-deep))] to-[hsl(var(--sky))] hover:from-[hsl(var(--sky))] hover:to-[hsl(var(--sky-deep))] text-white font-semibold h-11 text-base shadow-lg shadow-[hsl(var(--sky))]/30 transition-all duration-300"
              >
                {mode === "login" ? (
                  <>
            ...
            <Button
              ...
              disabled={loading}
              className="w-full border-[hsl(var(--border))] text-[hsl(var(--foreground))] hover:bg-[hsl(var(--sand))] h-11 font-medium"
            >
              ...
              {mode === "login" ? (
                <>
                  ...
                  <button
                    ...
                    className="text-[hsl(var(--sky-deep))] hover:text-[hsl(var(--sky))] font-semibold hover:underline transition-colors"
                  >
                    Create Account
                  </button>
                </>
